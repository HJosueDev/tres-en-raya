...
public class Controlador implements ActionListener{
    private Interfaz3x3 vista;
    private juego juego;
    private String titulo = "JUEGO 3 EN RAYA MVC * esenciainfotecnologica.jimdo.com j-net ";

     //En el constructor inicializamos nuestros objetos 
    public Controlador(Interfaz3x3 vista, juego modelo){
        this.vista = vista;
        this.juego = modelo;
    }
